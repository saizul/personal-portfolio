...
class PXL_Contact_Info_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            esc_html__('Foliohub Contact Info', 'foliohub'),
            array('description' => esc_html__('Show Author Information', 'foliohub'),)
        );
    }
    ...
    function widget($args, $instance)
    {
        ...
        <div class="pxl-contact-info-widget bg-image" style="background-image: url(<?php echo esc_url($bg_box_url)?>); ?>);">
            <div class="content-inner">
                <div class="pxl-item--icon"><i class="bi-telephone-fill el-effect-zigzag"></i></div>
                <?php if (!empty($phone_number)): ?>
                    <div class="pxl-phone--number"><?php echo esc_html($phone_number);?></div>
                <?php endif; ?>
                <?php if (!empty($description)): ?>
                    <div class="pxl-item--desc"><?php echo foliohub_html(nl2br($description)); ?></div>
                <?php endif; ?>
    ...
    function form($instance)
    {
        ...
        <div class="author-image-wrap">
            <label for="<?php echo esc_url($this->get_field_id('bg_box')); ?>"><?php esc_html_e('Author Image', 'foliohub'); ?></label>
            ...
            if ($bg_box != "") {
                ?>
                <a href="#" class="pxl-select-image pxl-btn" style="display: none;"><?php esc_html_e('Select Image', 'foliohub'); ?></a>
                <a href="#" class="pxl-remove-image pxl-btn"><?php esc_html_e('Remove Image', 'foliohub'); ?></a>
                <?php
            } else {
                ?>
                <a href="#" class="pxl-select-image pxl-btn"><?php esc_html_e('Select Image', 'foliohub'); ?></a>
                <a href="#" class="pxl-remove-image pxl-btn" style="display: none;"><?php esc_html_e('Remove Image', 'foliohub'); ?></a>
                <?php
            }
            ?>
        </div>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('phone_number')); ?>"><?php esc_html_e( 'Phone Number', 'foliohub' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('phone_link')); ?>"><?php esc_html_e( 'Phone Link', 'foliohub' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('description')); ?>"><?php esc_html_e('Description', 'foliohub'); ?></label>
