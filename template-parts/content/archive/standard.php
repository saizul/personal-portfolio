...
$archive_readmore_text = foliohub()->get_theme_opt('archive_readmore_text', esc_html__('Read More', 'foliohub'));
$post_social_share = foliohub()->get_theme_opt('post_social_share', false);
$archive_social = foliohub()->get_theme_opt('archive_social', true);
...
<article id="post-<?php the_ID(); ?>" <?php post_class('pxl-archive-post'); ?>>
    <div class="content-inner-post">
        <?php if (has_post_thumbnail()) {
            $archive_date = foliohub()->get_theme_opt('archive_date', true);
            ?>
                        ...
                        <div class="quote-inner">
                            <div class="content-top">
                                ...
                                <div class="content-right">
                                    <?php foliohub()->blog->get_archive_meta_2(); ?>
                                    <div class="quote-text">
                                        <a
                                            href="<?php echo esc_url(get_permalink()); ?>"><?php echo esc_html($quote_text); ?></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="link-inner">
                            ...
                            <div class="link-text">
                                <a class="link-text" target="_blank"
                                    href="<?php echo esc_url($link_url); ?>"><?php echo esc_html($link_text); ?></a>
                            </div>
                        </div>
                    </div>
                    <?php
                                ...
                                if (!empty($featured_video)) {
                                    ...
                                    <div class="pxl-video-popup">
                                        <div class="content-inner">
                                            <a class="video-play-button pxl-action-popup"
                                                href="<?php echo esc_url($featured_video); ?>">
