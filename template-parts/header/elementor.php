<?php 
$logo_m = foliohub()->get_opt( 'logo_m', ['url' => get_template_directory_uri().'/assets/img/logo.png', 'id' => '' ] );
$p_menu = foliohub()->get_page_opt('p_menu');
$header_mobile = foliohub()->get_page_opt('header_mobile', 'show');
$header_display = foliohub()->get_page_opt('header_display', 'show');
$sticky_scroll = foliohub()->get_opt('sticky_scroll');
$pm_menu = foliohub()->get_theme_opt('pm_menu');
...
$opt_mobile_style = foliohub()->get_opt('opt_mobile_style');
$mobile_display = foliohub()->get_opt('mobile_display');
$header_mobile_layout = foliohub()->get_opt('header_mobile_layout');
$header_mobile_layout_count = (int)foliohub()->get_opt('header_mobile_layout');
                ...
                <div class="row">
                    ...
                    <div class="pxl-header-menu">
                        <div class="pxl-header-menu-scroll">
                            ...
                            <?php foliohub_header_mobile_search_form(); ?>
