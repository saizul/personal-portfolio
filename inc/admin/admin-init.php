<?php
/**
* The Foliohub_Admin initiate the theme admin
*/
...
class Foliohub_Admin extends Foliohub_Base{
    ...
    public function fix_parent_menu() {
		...
		$submenu['pxlart'][0][0] = foliohub()->get_name().' '.esc_html__( 'Dashboard', 'foliohub' );
