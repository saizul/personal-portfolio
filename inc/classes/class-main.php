...
if (!class_exists('Foliohub_Main')) { 
    class Foliohub_Main extends Foliohub_Base
    {
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new Foliohub_Main();
            }
        ...
        public function get_sidebar_args($args = []){
            ...
            $sidebar_style = isset($args['sidebar_layout']) 
            ? $args['sidebar_layout'] 
            : $this->get_opt('sidebar_layout', 'style1');
            ...
            if (isset($_GET['sidebar-style'])) {
                $sidebar_style = $_GET['sidebar-style']; 
            }
            ...
            if ($sidebar_pos === '0' || $sidebar_pos === 'none' || $sidebar_pos === '' || !$sidebar_active) {
                ...
                if ($sidebar_style === 'style2') {
                    $sidebars['sidebar_class'] = 'pxl-sidebar-area pxl-sidebar-'.$args['type'].' col-12 col-lg-'.$sidebar_class.' style2';
                } else {
                    $sidebars['sidebar_class'] = 'pxl-sidebar-area pxl-sidebar-'.$args['type'].' col-12 col-lg-'.$sidebar_class.' '.$sidebar_style;
                }
            }
...
function foliohub() {
    return Foliohub_Main::getInstance();
}
// Install
foliohub(); 
